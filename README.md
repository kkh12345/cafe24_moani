...
![image](https://github.com/kkh12345/cafe24_moani/blob/main/login.png)
...
![image](https://github.com/kkh12345/cafe24_moani/blob/main/detail1.png)
![image](https://github.com/kkh12345/cafe24_moani/blob/main/detail2.png)

#### [ 주요 기능 ]

- 상품 카드를 클릭하여 이동
- 좋아요 기능(페이지를 새로고침해도 유지됨)
- 상품 이미지 줌 기능 직접 구현
- 상품 옵션을 선택하면 주문할 상품 정보가 하단에 표시됨
- 장바구니 버튼을 누르면 장바구니에 상품이 추가됨
...
![image](https://github.com/kkh12345/cafe24_moani/blob/main/cart1.png)
...
![image](https://github.com/kkh12345/cafe24_moani/blob/main/reviewPage.png)

#### [ 주요 기능 ]

- list,grid 두 가지 정렬 방식을 선택 가능
...
![image](https://github.com/kkh12345/cafe24_moani/blob/main/reviewDetail.png)

#### [ 주요 기능 ]

- 리뷰 카드를 클릭하여 이동 가능
- 이전글 다음글 이동
- 상품선택이 되지 않은 리뷰는 썸네일에 로고 표시
...
- 사용된 기술 :
  <img src="https://img.shields.io/badge/html5-E34F26?style=flat-square&logo=html5&logoColor=white"> <img src="https://img.shields.io/badge/css3-1572B6?style=flat-square&logo=css3&logoColor=white">  <img src="https://img.shields.io/badge/Swiper-6332F6?style=flat-square&logo=Swiper&logoColor=white">
